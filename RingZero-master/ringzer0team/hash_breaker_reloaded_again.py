...
def hash_breaker_reloaded_again():
    from Libraries import connectionLib, usefulLibrary
    from termcolor import colored
    import os

    URL_CHALLENGE = "http://ringzer0team.com/challenges/159"
    ...
    os.system('cd ringzer0team && generate_reloaded_again.py > ../Dicts/hash_reloaded_again.txt') #generate hash list
    answer = usefulLibrary.findSha1Hash('./Dicts/hash.txt', challenge)  #find the hash
    answer = str(answer)
